...
import { kurTipleri as seedRows, kurTipleriDetaylari as seedDetaylar } from '../../data/mockData'

function emptyForm() {
  return { id: null, kod: '', aciklama: '' }
}

export default function KurTipleri() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader
        title="Kur Tipleri"
        description="Kur tipi tanımları ve alt parametre detayları"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 flex-1 min-h-0">
        ...
        <div className="overflow-auto">
          <div className="p-4 border-b border-slate-200 bg-slate-50">
            ...
            <p className="text-xs text-slate-500 mt-1">Seçili kur tipine ait kaynak ve hesaplama kuralları</p>
          </div>
          <div className="p-4">
