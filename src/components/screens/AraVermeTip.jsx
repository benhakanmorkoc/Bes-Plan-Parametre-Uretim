...
import { araVermeTip as seedRows } from '../../data/mockData'
...
export default function AraVermeTip() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader title="Ara Verme Tip" description="Ara verme tipi tanımları" right={<PrimaryButton onClick={openCreate}><Plus className="w-4 h-4" /> Yeni Ekle</PrimaryButton>} />
