...
import {
  gecerliSozlesmeCinsi as seedRows,
  gecerliSozlesmeCinsiDetaylari as seedDetaylar,
} from '../../data/mockData'
...
export default function GecerliSozlesmeCinsi() {
  ...
  const openInspect = (row) => {
    setInfoModal({
      open: true,
      title: 'Geçerli Sözleşme Cinsi İncele',
      body: (
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader
        title="Geçerli Sözleşme Cinsi"
        description="Sözleşme cinsi tanımları ve alt operasyonel parametreler"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 flex-1 min-h-0">
        <div className="overflow-auto border-r border-slate-200">
          <table className="w-full grid-table">
            <thead>
              <tr>
                <th>Kod</th><th>Açıklama</th><th className="w-12 text-right">İşlemler</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="overflow-auto">
          <div className="p-4 border-b border-slate-200 bg-slate-50">
            ...
            <p className="text-xs text-slate-500 mt-1">Seçili sözleşme cinsine ait iş kuralı detayları</p>
          </div>
          <div className="p-4">
      ...
      <Modal
        ...
        title="Geçerli Sözleşme Cinsi Kaydı"
