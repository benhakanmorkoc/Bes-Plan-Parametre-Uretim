...
import {
  tarifePlanDurum as seedRows,
  tarifePlanDurumDetaylari as seedDetaylar,
} from '../../data/mockData'
...
export default function TarifePlanDurum() {
  ...
  const openInspect = (row) => {
    setInfoModal({
      open: true,
      title: 'Tarife Plan Durum İncele',
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader
        ...
        description="Tarife/plan durum tanımları ve durum bazlı iş kuralı detayları"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 flex-1 min-h-0">
        ...
        <div className="overflow-auto">
          <div className="p-4 border-b border-slate-200 bg-slate-50">
            ...
            <p className="text-xs text-slate-500 mt-1">Seçili duruma ait işleyiş kuralları</p>
          </div>
          <div className="p-4">
