...
import { tarifePlanDurum as seedRows } from '../../data/mockData'
...
export default function TarifePlanDurum() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      ...
      <Modal open={formOpen} onClose={() => setFormOpen(false)} title="Tarife Plan Durum Kaydı" footer={<><OutlineButton onClick={() => setFormOpen(false)}>Vazgeç</OutlineButton><PrimaryButton onClick={saveForm}>Kaydet</PrimaryButton></>}>
