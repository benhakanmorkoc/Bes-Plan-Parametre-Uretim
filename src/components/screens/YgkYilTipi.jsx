...
import { ygkYilTipi as seedRows } from '../../data/mockData'
...
export default function YgkYilTipi() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader title="YGK Yıl Tipi" description="YGK yıl tipi tanımları" right={<PrimaryButton onClick={openCreate}><Plus className="w-4 h-4" /> Yeni Ekle</PrimaryButton>} />
