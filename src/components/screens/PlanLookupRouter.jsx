...
const REGISTRY = {
  ...
  ygkBes30BirikimTipi: {
    title: 'YGK BES3.0 Birikim Tipi',
    description: 'YGK BES 3.0 birikim tipi tanımları',
    data: data.ygkBes30BirikimTipi,
    columns: [{ key: 'tanimAdi', label: 'Tanım Adı' }],
    searchKeys: ['tanimAdi'],
  },
  ygkBes30KesintiDonemi: {
    title: 'YGK BES3.0 Kesinti Dönemi',
    description: 'YGK BES 3.0 kesinti dönemi tanımları',
    data: data.ygkBes30KesintiDonemi,
    columns: [{ key: 'tanimAdi', label: 'Tanım Adı' }],
    searchKeys: ['tanimAdi'],
  },
  ygkBes30KesintiZamani: {
    title: 'YGK BES3.0 Kesinti Zamanı',
    description: 'YGK BES 3.0 kesinti zamanı tanımları',
    data: data.ygkBes30KesintiZamani,
    columns: [{ key: 'tanimAdi', label: 'Tanım Adı' }],
    searchKeys: ['tanimAdi'],
  },
  ygkBes30YgkKesintiTipi: {
    title: 'YGK BES3.0 YGK Kesinti Tipi',
    description: 'YGK BES 3.0 YGK kesinti tipi tanımları',
    data: data.ygkBes30YgkKesintiTipi,
    columns: [{ key: 'tanimAdi', label: 'Tanım Adı' }],
    searchKeys: ['tanimAdi'],
  },
  egpBireyTipi: {
