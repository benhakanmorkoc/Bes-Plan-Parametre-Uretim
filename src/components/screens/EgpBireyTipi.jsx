...
import { egpBireyTipi as seedRows } from '../../data/mockData'
...
export default function EgpBireyTipi() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader title="EGP Birey Tipi" description="EGP birey tipi tanımları" right={<PrimaryButton onClick={openCreate}><Plus className="w-4 h-4" /> Yeni Ekle</PrimaryButton>} />
