...
import { ygkYillikOdemeDonemi as seedRows } from '../../data/mockData'
...
export default function YgkYillikOdemeDonemi() {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 flex flex-col h-full overflow-hidden">
      <ScreenHeader title="YGK Yıllık Ödeme Dönemi" description="Ödeme dönemi tanımları" right={<PrimaryButton onClick={openCreate}><Plus className="w-4 h-4" /> Yeni Ekle</PrimaryButton>} />
