...
const REGISTRY = {
  ...
  egpGenel: {
    ...
    description: 'EGP plan icin genel parametreler',
    data: data.egpGenel,
    columns: [
      { key: 'kod', label: 'Kod' },
      { key: 'ad', label: 'Ad' },
  ...
  egpGeriOdeme: {
    title: 'EGP Geri Odeme Tipleri',
    data: data.egpGeriOdeme,
    columns: [
      { key: 'kod', label: 'Kod' },
      { key: 'ad', label: 'Ad' },
      { key: 'versiyon', label: 'V' },
      { key: 'tip', label: 'Geri Odeme Tipi' },
      { key: 'tarih', label: 'Tarih' },
      { key: 'sureAlt', label: 'Sure Alt' },
      { key: 'sureUst', label: 'Sure Ust' },
      { key: 'tutarAlt', label: 'Tutar Alt' },
      { key: 'tutarUst', label: 'Tutar Ust' },
      { key: 'oranUst', label: 'Oran Ust' },
      { key: 'faiz', label: 'Faiz' },
    ],
  },
  egpAraOdeme: {
    ...
    columns: [
      ...
      { key: 'versiyon', label: 'V' },
      { key: 'tarih', label: 'Tarih' },
      { key: 'sayiAlt', label: 'Sayi Alt' },
      { key: 'sayiUst', label: 'Sayi Ust' },
      { key: 'tutarUst', label: 'Tutar Ust' },
      { key: 'oranBirikim', label: 'Oran (Birikim)' },
      { key: 'oranMaas', label: 'Oran (Maas)' },
    ],
  },
}
